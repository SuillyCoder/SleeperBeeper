...
<h3>As mentioned, this Python-based program uses computer vision and a lot of other libraries in order to detect my face, the state of my eyes, and blare out an alarm. Specifically, this program was made with the following:</h3>
<ul>
